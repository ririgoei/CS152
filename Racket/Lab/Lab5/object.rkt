...
(define (get-name emp) (get-val (car emp)))

(define (set-name emp new-name)
  (set-val! (car emp) new-name))

(define (get-position emp) (get-val (car (cdr emp))))

(define (set-position emp new-pos) (set-val! (car (cdr emp)) new-pos))

(define (get-salary emp) (get-val (car (cdr (cdr emp)))))

(define (set-salary emp new-pos) (set-val! (car (cdr (cdr emp))) new-pos))
